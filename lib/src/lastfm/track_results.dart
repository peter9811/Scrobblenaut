...
class TrackSearchResults {
  ...
  @JsonKey(name: 'trackmatches', fromJson: LastFMValueNormalizer.tracksExtractor)
  List<Track>? tracks;
  ...
  factory TrackSearchResults.fromJson(Map<String, dynamic> json) => _$TrackSearchResultsFromJson(json);
