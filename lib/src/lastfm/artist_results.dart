...
class ArtistSearchResults {
  ...
  @JsonKey(name: 'artistmatches', fromJson: LastFMValueNormalizer.artistsExtractor)
  List<Artist>? artists;
  ...
  factory ArtistSearchResults.fromJson(Map<String, dynamic> json) => _$ArtistSearchResultsFromJson(json);
